...
*/
    ...
    define("DEBUG", true);
    //Stateful flag that determines whether the Web application is stateful or not If it is set to true the <strong class="partify">partify</strong> WebSocket server stateful parameter must be set to true, too.
    ...
    $ALLOWED_ORIGINS = array("http://".WS_SERVER_IP, "http://partify.org", "http://www.partify.org");
